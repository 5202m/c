...
var studioChatMb = {
        ...
        this.getArticleList("teach_video_base,teach_video_gw,teach_video_expert", this.userInfo.groupId, 0, 1, 100, '{"sequence":"desc","publishStartDate":"desc"}', null, function(dataList) {
            ...
            if (dataList && dataList.result == 0) {
                ...
                loc_panel.find("li a").click(function() {
                    ...
                    chatAnalyze.setUTM(false, $.extend({ operationType: 7, videoId: $(this).attr("id"), videoName: $(this).text() }, studioChatMb.userInfo, studioChatMb.courseTick.course)); //统计教学视频点击数
                });
            }
    ...
    setEventChat: function() {
        ...
        $("#sendBtn").click(function() {
            ...
            chatAnalyze.setUTM(false, $.extend({ operationType: 2 }, studioChatMb.userInfo, studioChatMb.courseTick.course)); //统计发言次数
        });
    ...
    video: {
        ...
        start: function(isBack) {
            ...
            if (!course || course.isNext || (course.courseType != 0 && common.isBlank(course.studioLink)) || course.courseType == 2 || course.courseType == 0) {
                ...
                this.player.play(course.studioLink, "");
            }
        },
        /**
         *随机播放MP4视频
        ...
        popVideoWindow: function() {
            ...
            window.open("/gotoVideo?" + params, 'studioVideoWindow', 'height=600,width=800,top=0,right=0,toolbar=no,menubar=no,scrollbars=no,location=no,status=no');
        },
    ...
    whTalk: {
        ...
        loadMsg: function(csId) {
            ...
            $.post(studioChatMb.apiUrl + "/message/getWhMsg", whMsgObj,
                function() {
                    console.log("ok");
                });
        },
        ...
        sendWhMsg: function(sendObj) {
            ...
            chatAnalyze.setUTM(false, $.extend({ operationType: 8, userTel: $('#person_mb').text() }, studioChatMb.userInfo, studioChatMb.courseTick.course)); //统计发言次数
        }
    },
    /**
     * 加载推送消息
    ...
    courseTick: {
        ...
        tick: function() {
            ...
            if (currCourse.isNext) { //下次课程开始作为下一次tick时间
                ...
                nextTime = eval(currCourse.startTime.replace(":", "*60+")) * 60000 + studioChatMb.serverTime - studioChatMb.serverTime % 86400000 + timezoneOffset;
            } else { //本次课程结束后作为下一次tick时间
                nextTime = eval(currCourse.endTime.replace(":", "*60+")) * 60000 + studioChatMb.serverTime - studioChatMb.serverTime % 86400000 + timezoneOffset + 60000;
            }
