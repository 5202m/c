...
var studioMbPerson = {
    ...
    getUserLevelIco : function(clientGroup, avatar){
        ...
        var userLevelIco = "/theme4/img/user_c.png";
        switch(clientGroup) {
            case "vip" :
                userLevelIco = "/theme4/img/user_v.png";
                break;
            case "active" :
                userLevelIco = "/theme4/img/user_r.png";
                break;
            case "notActive" :
                userLevelIco = "/theme4/img/user_r.png";
                break;
            case "simulate" :
                userLevelIco = "/theme4/img/user_d.png";
                break;
            case "register" :
                userLevelIco = "/theme4/img/user_m.png";
                break;
        }
        return userLevelIco;
    },
...
var studioMbSet = {
    ...
    setEvent : function(){
        $("#setForm_sub").bind("click", function(){
            ...
            common.getJson("/modifyName",$("#setForm").serialize(),function(result){
...
var studioMbPwd1 = {
    ...
    setEvent : function(){
        $("#pwd1Form_sub").bind("click", function(){
            ...
            common.getJson("/resetPwd",$("#pwd1Form").serialize(),function(result){
...
var studioMbPwd2 = {
    ...
    setEvent : function(){
        $("#pwd2Form_sub").bind("click", function(){
            ...
            common.getJson("/resetPwd",$("#pwd2Form").serialize(),function(result){
...
var studioMbPwd3 = {
    ...
    setEvent : function(){
        $("#pwd3Form_sub").bind("click", function(){
            ...
            common.getJson("/resetPwd",$("#pwd3Form").serialize(),function(result){
...
var studioMbPop = {
    ...
    changeRoomMsg : function(ops){
        ...
        this.showMessage((ops.msg || msgMap["noAuth"]) + "如有疑问请联系老师助理。");
    },
    /**
     * 遮罩层
     * @param $panel
