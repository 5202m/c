...
var videosLive = {
    ...
    setSymbolOpenPositionRatios: function() {
        ...
        $.getJSON('/getSymbolOpenPositionRatios', null, function(data) {
            if (data != null && data.code == 'SUCCESS') {
                ...
                var soprHtml = [],
                    soprFormat = videosLive.formatHtml('symbolOpenPositionRatios');
    ...
    setInformation: function() {
        var scrollDom = $(".message_list ").find('.scrollbox'),
            intervalTime = $('#newInfoCount').attr('t');
        ...
        $.getJSON(indexJS.apiUrl + '/common/getInformation?t=' + indexJS.serverTime, null, function(result) {
            if (result) {
                if (result.isOK) {
                    var pt = $('#newInfoCount').attr('pt'),
                        pubDateTime = null,
                        newsHtml = '',
                        newsFormatHtml = videosLive.formatHtml('news');
