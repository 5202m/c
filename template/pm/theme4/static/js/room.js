    ...
    setSocket:function(){
        ...
        this.socket.on('connect',function(){
            ...
            studioChatMb.socket.emit('login',{
                    courseId:courseId,courseName:courseName,cookieId:chatAnalyze.getUTMCookie(),userName:studioChatMb.userInfo.userName,roomName:studioChatMb.userInfo.roomName,email:studioChatMb.userInfo.email,
