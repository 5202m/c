...
var Data = {
    ...
    initUserInfo : function(){
        ...
        var key='storeInfos_'+Data.userInfo.groupType, keyVal=Store.store(key);
        var obj={};
    ...
    getVideoUrl : function(syllabusPlan){
        var result = {pc:"", mobile:"", audio:"", oneTV:"", https:""}, linkTmp = null;
    ...
    getUserLevel : function(point){
        var result = Data.pointLevel[0].name, pointLevelTmp;
