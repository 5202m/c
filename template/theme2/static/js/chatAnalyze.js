    ...
    setUTM:function(init,data){
        try{
            ...
            if(init){
                ...
                chatAnalyze.utmStore.platformType = Util.isMobile(navigator.userAgent)?1:0;
                ...
                chatAnalyze.utmStore.operateEntrance = Util.isBlank(Util.getUrlParam('platform'))?'web':Util.getUrlParam('platform');
                ...
                if(Util.isNotBlank(data.sessionId) && Util.isNotBlank(data.userId) && (Util.isNotBlank(data.touristId) || Util.isNotBlank(data.userTel)) && /*(*/Util.isNotBlank(data.operationType) /*|| $.inArray(data.userType, [7,8,9])>-1)*/){
    ...
    sendUTM:function(data){
        ...
        try{
            ...
            var sendData={
                ...
                platformType:(Util.isMobile()?1:0),
