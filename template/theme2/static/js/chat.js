    ...
    setEvent: function() {
        ...
        $("#chat_cont").bind('click', function() {
            ...
            if (e.keyCode == 8) {
                ...
                var divText = $(this).text().replace(/(^\s*)/g, ""),
                    spanText = $(this).find('span').text().trim();
            ...
            if ($.inArray(1, Chat.face.initArray) < 0) {
                ...
                Data.getRoom(function(room) {
                    ...
                    Chat.face.init($("#chat_facePanel"),
                        $("#chat_cont"),
                        Data.filePath + '/face/', !room || (!room.allowVisitor && "visitor" == Data.userInfo.clientGroup), 1);
