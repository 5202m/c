    ...
    if (adminUserInfo) {
        ...
        async.parallel({
            ...
            function(err, results) {
                ...
                res.render(global.rootdir + '/template/admin/view/index',
                    viewDataObj);
            });
    } else {
            ...
            function(err, results) {
                if (!results.checkResult) {
                    ...
                    if (results.getGroup) {
                        ...
                        viewDataObj.groupInfo.allowWhisper = common.containSplitStr(
                            viewDataObj.groupInfo.talkStyle, 1);
                    }
                    ...
                    viewDataObj.isDevTest = config.isDevTest;
                    res.render(global.rootdir + '/template/admin/view/room',
                        viewDataObj);
                }
            });
    } else {
...
router.post('/modifyArticle', function(req, res) {
    ...
    if (adminUserInfo) {
        ...
        var searchObj = {
            _id: where._id,
            detailList: { $elemMatch: { lang: where.lang } }
        };
...
router.post('/getLastTwoDaysMsg', function(req, res) {
    ...
    if (common.isBlank(params.groupType) || common.isBlank(params.groupId) ||
