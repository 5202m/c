    ...
    it("Should work as expect.", (done) => {
        studioService.getTrainRoomList(
            ...
            (data) => {
                ...
                data.should.be.an.Array();
                data.length.should.be.aboveOrEqual(1);
                (data[0]).should.have.keys("_id", "groupType", "name", "talkStyle",
                    "clientGroup", "defaultAnalyst");
        ...
        studioService.getUserInfoByUserNo(
            ...
            (data) => {
                ...
                data.should.have.keys("_id", "userNo", "userName", "position",
                    "introduction", "introductionImg", "winRate", "praiseNum");
    ...
    it("Should work as expect.", (done) => {
        studioService.getShowTeacher(
            ...
            (data) => {
                should(data).not.be.null();
                data.should.be.an.Object();
                data.should.have.keys("userInfo", "tradeList", "teacherList",
                    "trAndClNum", "trainList");
            }
        ).catch((e) => {
            logger.error(e);
            done();
