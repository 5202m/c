...
let logger = require('../resources/logConf').getLogger("testchatSubscribeTypeService");
...
describe("chatSubscribeTypeService.getSubscribeTypeList", () => {
    ...
    it("chatSubscribeTypeService.getSubscribeList should work as expect.", (done) => {
	chatSubscribeTypeService.getSubscribeTypeList({groupType: "studio"}, (data) => {
	...
	chatSubscribeTypeService.getSubscribeTypeList({groupType: "studio"}).then((data) => {
	    should(data).not.be.null();
	    data.should.be.Array();
	    data.forEach((e) => {
		e.should.have.property("_id");
