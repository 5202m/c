...
describe("chatPraiseService.getPraiseNum", () => {
    ...
    it("chatPraiseService.getPraiseNum should work good.", (done) => {
        chatPraiseService.getPraiseNum("U150511B000005", "user", "fxchat",
            (data) => {
                data.should.not.be.null();
            });
        chatPraiseService.getPraiseNum("U150511B000005", "user", "fxchat").then(
            (data) => {
                data.should.not.be.null();
                done();
            });
...
describe("chatPraiseService.setPraise", () => {
    ...
    it("chatPraiseService.setPraise should work good.", (done) => {
        ...
        chatPraiseService.setPraise("U150511B000005", "user", "fxchat").then(
            (data) => {
                data.should.not.be.null();
                done();
            });
