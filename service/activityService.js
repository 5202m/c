...
var activityService = {
    ...
    getTotalMoneyInfo:function (periods,fn) {
        periods = periods || "";
        var url = config.pmOAPath+"/activity20170201/getTotalMoneyInfo?periods="+periods;
    ...
    getRewardMoneyInfo: function (phoneNo,page,fn) {
        phoneNo = phoneNo || "";
        page = page || "";
        var url = config.pmOAPath+"/activity20170201/getRewardMoneyInfo?phoneNo="+phoneNo+"&page="+page;
    ...
    getLotteryInfo: function (phoneNo,periods,fn) {
        phoneNo = phoneNo || "";
        periods = periods || "";
        var url = config.pmOAPath+"/activity20170201/getLotteryInfo?phoneNo="+phoneNo+"&periods="+periods;
